 ...
 * 0771业务授权过程
 * <p>
 * 客户账号 查询azhjx查询出的YNGYJG│营业机构号！=查的营业机构，输入授权编码1 查询授权级别和授权原因 非客户查询，查BDSKH表 查出
 * SHFOBZ=1输入授权编码3
 * 
 * @author user
 * 
 */
public class Authorize0771 extends AbsAuthorize {
	private static final Log LOG = LogFactory.getLog(Authorize0771.class);
