 ...
 * 
 */
public class SkyHTablePool implements Closeable {
	 ...
	 */
	public SkyHTablePool(final Configuration config, final int maxSize) {
	 ...
	 *            table factory
	 */
	public SkyHTablePool(final Configuration config, final int maxSize, final HTableInterfaceFactory tableFactory) {
	 ...
	 */
	public SkyHTablePool(final Configuration config, final int maxSize, final PoolType poolType) {
	...
	class PooledHTable implements HTableInterface {
		...
		public <T extends CoprocessorProtocol, R> void coprocessorExec(Class<T> protocol, byte[] startKey,
				byte[] endKey, Batch.Call<T, R> callable, Batch.Callback<R> callback) throws IOException, Throwable {
