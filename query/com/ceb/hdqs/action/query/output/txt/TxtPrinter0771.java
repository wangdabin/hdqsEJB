...
public class TxtPrinter0771 extends TxtMaker<PrivateLiquidQueryItem> {

	public TxtPrinter0771(PybjyEO record) {
		super(record);
	}

	@Override
	public void write(Page<PrivateLiquidQueryItem> page) {
		pageCount++;
		...
		if (StringUtils.isNotBlank(page.getHeader().getTips())) {
			...
			for (PrivateLiquidQueryItem item : page.getPageItem()) {
				printer.printf("%1s", "");
