...
public class JSPUtility {
	...
	/**
	 * Converts the given String to a double. Return null if the String is null
	 * or non-numeric.
	 */
	 ...
	 *            the base page
	 * @param params
	 *            key-value pairs of parameters passed in to the page URL. null
	 *            or empty argument is allowed.
	...
	public static String encodeURL(String page, Object... params) {
		...
		if (params != null && params.length != 0) {
			if (params.length % 2 != 0) {
				throw new IllegalArgumentException("Odd number of encoding parameters " + Arrays.toString(params) + " to " + page);
			}
