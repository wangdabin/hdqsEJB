...
public class PdfGenerator0781 extends PdfGenerator<Item0781> {

	@Override
	public String makeXhtml(PybjyEO record, OutPdfContext ctx, List<Item0781> itemList, int pageNum, Object obj) throws IOException {
		...
		String str = TemplateEngine.getInstance().parseTemp(context, "0781.xhtml");
		return str;
	}
