...
public class PdfGenerator0771 extends PdfGenerator<Item0771> {

	@Override
	public String makeXhtml(PybjyEO record, OutPdfContext ctx, List<Item0771> itemList, int pageNum, Object obj) throws IOException {
		...
		String str = TemplateEngine.getInstance().parseTemp(context, "0771.xhtml");
		return str;
	}
