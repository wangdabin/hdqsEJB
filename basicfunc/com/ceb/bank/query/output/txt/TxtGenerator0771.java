...
public class TxtGenerator0771 extends TxtGenerator<Item0771> {
	@Override
	...
	private void write(PybjyEO record, OutPdfContext ctx) {
		Output0771Context pageCtx = (Output0771Context) ctx;
		getPrinter().printf("%101s\r\n\r\n", "中国光大银行对私活期账户对帐单(本对帐单仅供参考)");
	...
	@Override
	public void write(PybjyEO record, OutPdfContext ctx, List<Item0771> itemList, Object zhCtx) {
		Output0771Context pageCtx = (Output0771Context) ctx;
		...
		if (itemList == null || itemList.isEmpty()) {
			...
			for (Item0771 item : itemList) {
				...
				DbcSbcUtils.fixLeftPrint(getPrinter(), item.getShdhdm(), 6);
