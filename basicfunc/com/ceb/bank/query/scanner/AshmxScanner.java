...
public class AshmxScanner extends AbstractQuery<Item0771> {
	private static final Logger log = Logger.getLogger(AshmxScanner.class);
	...
	protected Item0771 parse(Result result) throws IOException {
		...
		Map<String, byte[]> qualifiers = HAshmxField.getMxQualifiers();
