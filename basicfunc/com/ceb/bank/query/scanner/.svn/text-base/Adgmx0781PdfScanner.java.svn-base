...
public class Adgmx0781PdfScanner extends AbstractQuery<Item0781> {

	public Adgmx0781PdfScanner() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public List<Item0781> query(PybjyEO record, ZhanghContext zhanghCtx, int pageSize) throws Exception {
		...
		List<Item0781> itemList = scan(scanner, limit);
