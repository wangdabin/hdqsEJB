...
public class HandleAsyn0771 extends AbstractHandleAsyn {
	private static final Logger log = Logger.getLogger(HandleAsyn0771.class);
	...
	public HandleAsyn0771(List<PybjyEO> list) {
		super(list);
	}
	...
	public void execute() throws Exception {
		...
		try {
			...
			update(record);
			timer.stop();
			log.info("异步0771查询完成,Cost time(ms)=" + timer.getExecutionTime());
		}
	}
